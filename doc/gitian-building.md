...
git clone https://github.com/dashbanana/dash
```
...
```bash
    ...
    From https://github.com/dashbanana/dash
...
cd /some/root/path/
git clone https://github.com/dashbanana/dash-detached-sigs.git
...
[dash/gitian.sigs](https://github.com/dashbanana/gitian.sigs/) repository, or if that's not possible to create a pull
request.
