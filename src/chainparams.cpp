...
{
    const char* pszTimestamp = "It's a bird! It's a plane! It's DASH! 180311";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 2.0 * 60; // Dash: 2.0 minutes
        ...
        // Dash addresses start
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,73);
        // Dash script addresses start
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,15);
        // Dash private keys start
...
public:
    CTestNetParams() {
        ...
        // Testnet Dash addresses start
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,117);
        // Testnet Dash script addresses start
...
public:
    CRegTestParams() {
        ...
        // Regtest Dash addresses start
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,141);
        // Regtest Dash script addresses start
